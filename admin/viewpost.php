            ...
            <form action = "" method = "POST" enctype = "multipart/form-data">
                <table class = "form">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type = "text" readonly="1" name = "post_title" value="<?php echo $p_title ?>" 
                    ...
                    <tr>
                        ...
                        <td>
                            <select id = "select" readonly="1"  name = "category_id">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea class="tinymce"  readonly="1"  rows="10" cols="60" name="post_body" value=""><?php echo $p_body ?></textarea>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="date-picker"  readonly="1"  name="post_tag" value="<?php echo $p_tag ?>" />
                        </td>
                    </tr>
